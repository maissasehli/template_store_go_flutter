...
class ReviewSectionState extends State<ReviewSection> {
  ...
  double get averageRating {
    ...
    return controller.reviews
        .map((r) => r.rating)
        .reduce((a, b) => a + b) / controller.reviews.length;
  }
            ...
            Expanded(
              child: Column(
                children: List.generate(5, (index) {
                  ...
                  final reviewsWithThisRating = controller.reviews
  ...
  Widget _buildWriteReviewButton() {
    return GestureDetector(
      onTap: () => _isWritingReview.value = true,
      child: Container(
        padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 16),
        decoration: BoxDecoration(
          color: Colors.white,
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.rate_review_outlined, size: 18, color: AppColors.primary(context)),
            const SizedBox(width: 8),
            Text(
              'Write a Review',
              style: TextStyle(
